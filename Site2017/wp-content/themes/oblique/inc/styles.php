...
function oblique_custom_styles( $custom ) {
	...
	// Footer background
	$footer_background = get_theme_mod( 'footer_background', apply_filters( 'oblique_footer_background_color', '#fffa00' ) );
	...
	// Body
	$body_text = get_theme_mod( 'body_text_color', apply_filters( 'oblique_body_background_color', '#fff600' , 'oblique_body_text_color' ,'#000000' ) );
	if ( ! empty( $body_text ) ) {
